        ...
        for (int x = 0; x < taulukko.length; x++) {
            for (int y = 0; y < taulukko[0].length; y++) {
                ...
                if (this.elossaOleviaNaapureita(taulukko, x, y) < 2) { //1.sääntö
                    kopio[x][y] = 0;
                } else if (kopio[x][y] == 1 && (this.elossaOleviaNaapureita(taulukko, x, y) == 2 || this.elossaOleviaNaapureita(taulukko, x, y) == 3)) {
                    kopio[x][y] = 1; //2. sääntö
                } else if (this.elossaOleviaNaapureita(taulukko, x, y) >= 4) {
                    kopio[x][y] = 0; //3. sääntö
                } else if (kopio[x][y] == 0 && this.elossaOleviaNaapureita(taulukko, x, y) == 3) {
                    kopio[x][y] = 1;
                }
            }
        }
