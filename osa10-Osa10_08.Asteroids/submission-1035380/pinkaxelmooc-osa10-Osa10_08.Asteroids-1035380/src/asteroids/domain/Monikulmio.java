...
päivitys 1.0: nyt Monikulmion jälkeläiset perivätliiku metodin ilman että siitä pitää
mainita erikseen(paitsi asteroidin tapauksessa, kun kyseiseen metodiin pitää lisätä toiminnallisuus).
 */
public class Monikulmio {
    ...
    public void liiku(long nanosekuntiaViimePaivityksesta) {
        this.sijainti.setX(this.sijainti.getX() + this.sijainti.getX());
        this.sijainti.setY(this.sijainti.getY() + this.sijainti.getY());
    }
}
