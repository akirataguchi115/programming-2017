...
class Numerotiedustelu {
    ...
    private Map<String, String> kaupungitNimenperusteella; //7:aa varten myös...//
    ...
    public Numerotiedustelu() {
        ...
        this.kaupungitNimenperusteella = new HashMap<>();
    }
        ...
        while (jatka) {
            ...
            if (komento.equals("4")) {
                ...
                if (henkilotNimenPerusteella.containsKey(nimi)) {
                    ...
                    kaupungitNimenperusteella.put(nimi, kaupunki);
                } else {
            ...
            if (komento.equals("5")) {
                ...
                //oletuksella että syöte on oikein muuten tulee NPE joo no kiva ei ookkaa
                if (henkilotNimenPerusteella.isEmpty()) {
                    System.out.println("  ei löytynyt");
                } else if (henkilotNimenPerusteella.containsKey(kenen)) {
                    if (henkilotNimenPerusteella.get(kenen).getKadut().isEmpty() && henkilotNimenPerusteella.get(kenen).getKaupunki().isEmpty()) {
            ...
            if (komento.equals("6")) { //MUISTA PÄIVITTÄÄ TÄTÄ KANS JOS MUUTAT LISTOI
                ...
                kaupungitNimenperusteella.remove(kenet);
            }
            ...
            if (komento.equals("7")) {
                ...
                if (haku.isEmpty()) {
                    ...
                    for (int u = 0; u < nimet.size(); u++) {
                        ...
                        if (henkilotNimenPerusteella.get(nimet.get(u)).getKadut().isEmpty() && henkilotNimenPerusteella.get(nimet.get(u)).getKaupunki().isEmpty()) {
                            ...
                            System.out.print("    osoite: "); //OSOITE ALKAA TÄSTÄ
                        ...
                        if (henkilotNimenPerusteella.get(nimet.get(u)).getNumero().isEmpty()) { //PUHELINNUMERO IFFIT
                            System.out.println("    ei puhelinta");
                        } else {
                            System.out.println("    puhelinumerot: ");
                ...
                } else if (!kaupungitNimenperusteella.containsValue(haku) && !henkilotNimenPerusteella.containsKey(haku)) {
                    System.out.println("  ei löytynyt");
                } else {
                    List<String> halututNimet = new ArrayList<>();

                        for (int e = 0; e < kaupungitNimenperusteella.size(); e++) {
                            if (kaupungitNimenperusteella.get(nimet.get(e)).equals(haku)) {
...
//tää tehtävä on ihan kamala oon jumittunu tänne 3ksi päiväksi
